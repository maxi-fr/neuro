...
spectrum with, so two components closer together than $\Delta f$ are reported as one
\cite{Oppenheim2010}. Resolving finer structure means a longer segment, and a longer segment
...
sidelobes and widens the central peak to roughly twice $\Delta f$ in exchange
\cite{Oppenheim2010}. This thesis uses the periodic Hann taper throughout, in the training
