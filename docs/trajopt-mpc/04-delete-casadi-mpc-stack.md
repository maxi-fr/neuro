...
model bridges. Two of those bridges (`nn_predictor_casadi.py`, `esn_predictor_casadi.py`,
`observable_casadi.py`, and `artifacts.py::build_symbolic_model`) are already slated for removal by
