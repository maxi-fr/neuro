"""Pin the torch AutoregressiveMLP against the training-window seam and guard the torch-free path."""
...
def _build_checkpoint(depth: int, activation: Activation) -> MLPCheckpoint:
    """The float64 checkpoint twin of the module, for the torch-free side of a parity test."""
    layers, y_std, u_std = _params(depth, activation)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "neuro.control.trajopt_costs",
        "neuro.control.trajopt_mpc",
    ],
)
