...
@pytest.fixture
def make_observable_checkpoint() -> Callable[..., ObservableCheckpoint]:
    """Factory for a tiny synthetic observable checkpoint with random weights and real standardizers."""
