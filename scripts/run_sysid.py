...
from neuro.jansen_rit_casadi import JRSymbolicParams, heun_step, measure
...
def main(  # noqa: PLR0915
    *,
    ...
    try:
        ...
        _, x_open = simulate_network(params=JansenRitParams(A=4.0), connectome=connectome, duration=10.0, dt=DT, seed=42)
    ...
    if h_max > 0:
        ...
        for h in range(h_max):
            ...
            y_h = measure(x_hist[0], sym_params.eeg_gain)  # type: ignore
