...
- Pages updated:
  - [[concepts/closed-loop-brain-stimulation.md|Closed-loop Brain Stimulation]]
- New concepts: 3
...
## [2026-05-14] maintenance | Mathematical Backfill

- Action: Integrated mathematical descriptions into existing wiki pages.
- Status: Completed
- Updated Skill: `skills/ingest/SKILL.md` (added mathematical extraction guidelines)
- Pages updated:
  - [[concepts/fitzhugh-nagumo-model.md]]
  - [[concepts/hodgkin-huxley-model.md]]
  - [[concepts/human-connectome.md]]
  - [[concepts/optimal-nonlinear-control.md]]
  - [[concepts/volterra-model.md]]
  - [[concepts/neural-mass-model.md]]
  - [[concepts/model-predictive-control.md]]
...
## [2026-05-16] optimize | Wiki optimization pass

- Pages compacted: 1 (log.md garbled entry fixed)
- Pages merged: 1 (concepts/input-convex-neural-network.md merged into concepts/difference-of-convex-functions.md)
- Pages reorganized: 0
- Cross-references added: 14 (across 10 concept pages)
- Synthesis pages created: 2 (synthesis/control-strategy-landscape.md, synthesis/brain-model-taxonomy.md)
...
## [2026-05-18] synthesis | Neurostimulation Approaches

- Action: Created a standardized synthesis of the five primary neurostimulation approaches.
- Status: Completed
- Pages created:
  - [[synthesis/neurostimulation-approaches.md|Neurostimulation Approaches Synthesis]]
- Pages updated:
